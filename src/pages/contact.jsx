        ...
        <div className="container mx-auto px-6 py-24 md:py-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Have questions about StudentSync? Our team is ready to assist you with implementation, training, or any other inquiries.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">support@studentsync.com</p>
                  <p className="text-gray-600">sales@studentsync.com</p>
                </div>
              </div>
